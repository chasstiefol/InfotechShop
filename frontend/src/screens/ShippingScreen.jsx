...
const ShippingScreen = ({ history }) => {
  ...
  const submitHandler = (e) => {
    e.preventDefault()
    dispatch(saveShippingAddress({ provinsi, city, kecamatan, postalCode, address }))
    ...
    <FormContainer>
      ...
      <Form onSubmit={submitHandler} >
        <Form.Group controlId='provinsi'>
          <Form.Label className="text-black font-weight-bold">Provinsi</Form.Label>
          <Form.Control
            type='text'
        ...
        <Form.Group controlId='city'>
          <Form.Label className="text-black font-weight-bold">Kota/Kabupaten</Form.Label>
          <Form.Control
            type='text'
        ...
        <Form.Group controlId='kecamatan'>
          <Form.Label className="text-black font-weight-bold">Kecamatan</Form.Label>
          <Form.Control
            type='text'
        ...
        <Form.Group controlId='postalCode'>
          <Form.Label className="text-black font-weight-bold">Kode Pos</Form.Label>
          <Form.Control
            type='text'
        ...
        <Form.Group controlId='address'>
          <Form.Label className="text-black font-weight-bold">Alamat Lengkap</Form.Label>
          <Form.Control
            as='textarea'
